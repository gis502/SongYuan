...
/** PHPWORD_BASE_PATH */
if(!defined('PHPPower_BASE_PATH')) {
    define('PHPPower_BASE_PATH', dirname(__FILE__) . '/');
    //require_once PHPPower_BASE_PATH . 'PHPPowerpoint/Autoloader.php';
...
require_once PHPPower_BASE_PATH . 'PHPPowerPoint/DocumentProperties.php';

/** PHPPowerPoint_Shared_ZipStreamWrapper */
require_once PHPPower_BASE_PATH . 'PHPPowerPoint/Shared/ZipStreamWrapper.php';

/** PHPPowerPoint_SlideIterator */
require_once PHPPower_BASE_PATH . 'PHPPowerPoint/SlideIterator.php';
