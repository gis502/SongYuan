...
require_once PHPPower_BASE_PATH.'PHPPowerPoint/Shape/RichText/ITextElement.php';

/** PHPPowerPoint_Shape_RichText_TextElement */
require_once PHPPower_BASE_PATH.'PHPPowerPoint/Shape/RichText/TextElement.php';

/** PHPPowerPoint_Shape_RichText_Run */
require_once PHPPower_BASE_PATH.'PHPPowerPoint/Shape/RichText/Run.php';

/** PHPPowerPoint_Shape_RichText_Break */
require_once PHPPower_BASE_PATH.'PHPPowerPoint/Shape/RichText/Break.php';

/** PHPPowerPoint_Style_Alignment */
require_once PHPPower_BASE_PATH.'PHPPowerPoint/Style/Alignment.php';
