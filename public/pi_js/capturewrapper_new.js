...
function Capture(i) 
{
   ...
   var autoFlag = 1;
    ...
    else
    {
        ...
        {
            return captureObj.DoCapture("1.jpg", hideFlag, 1,460,300,980,450);
        }
    }             
}
...
function UploadData()
{
    ...
    $.ajax({
            ...
            success: function (obj) {
		        ...
		        {
			        layer.msg('上传失败 :' + obj.info);
		        }					
            },
            error : function(){ //layer.msg('n 原因，上传失败。');
         }
        });  
}  
